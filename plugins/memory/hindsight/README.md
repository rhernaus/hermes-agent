...
| `retain_indicator` | `true` | Show the `Sending to memory…` status line when a retain is dispatched (sending to memory has started; this does not mean the turn was saved). Turn off for customer-facing agents. |
